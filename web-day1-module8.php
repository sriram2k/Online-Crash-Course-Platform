    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 8:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp JavaScript</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">JavaScript</h6>
            ...
            <p class="text-dark">JavaScript is a dynamic computer programming language. It is lightweight and most commonly used as a part of web pages, whose implementations allow client-side script to interact with the user and make dynamic pages. The javascript is given inside the 'script' tags. Javascript uses functions to access and alter the HTML content one of the common functions is a getElementById(). This is get the element with the given id. Lets learn about that in this video</p>
            
            </div>
            </div>
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/j3MowVVBUYA?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
             <br>
