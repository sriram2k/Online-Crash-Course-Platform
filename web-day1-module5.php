    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 5:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp Links & Images</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Links & Images</h6>
            ...
            <p class="text-dark">Links allow the user to navigate from one webpage to another. You can specify links to HTML files on the same website or even the websites on the internet. You can specify links in HTML with the help of anchor tag <a>. Just like the <a> tag can be used to specify a hyperlink, we can make use of the <img> tag to display an image on our webpage. In this video, we’ll see examples for both of these. As an exercise, copy the code from the video and try to create a webpage that displays an image of your choice</p>
            
            </div>
            </div>
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/nZIXG6kkPGY?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
             <br>
                
                <a href="web-day1-module4.php">
                    <button class="btn btn-dark" style="float: left;border-radius: 0px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Prev</button>
                </a>
                <a href="web-day1-module6.php">
