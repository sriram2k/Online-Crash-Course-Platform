    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 5:</h5>
                <h5><i class="fa fa-database" aria-hidden="true"></i>&nbsp Select Statement</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Select Statement</h6>
            ...
            <p class="text-dark">Once you have created a table and inserted some data into it, you might now have a need to know what data is inside your table. In order to know this, you need to retrieve the data that is present inside the table. We have the SELECT command for this purpose. The select command can be used to retrieve all the data or only those data that satisfy particular conditions. In this video, we’ll discuss the SELECT query without using conditions. 
            </p>
            </div>
            </div>
             <iframe width="100%" height="400" src="https://www.youtube.com/embed/p1vDSgT2D2M?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
             <br><br>
