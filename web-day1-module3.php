    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 3:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp Headings & Paragraphs</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Headings & Paragraphs</h6>
            ...
            <p class="text-dark">
Headings are used to improve the readability of the document by dividing the content into smaller parts and naming them with subheadings. Based on the content type and size, you can make use of 6 levels of heading tags starting from h1 till h6. On the other hand, paragraphs are used to display text content in the webpage as a single block. By default, the browser adds a line break between paragraphs. </p>
            ...
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/-pV2WCCuQ50?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
             <br>
