    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 7:</h5>
                <h5><i class="fa fa-database" aria-hidden="true"></i>&nbsp Delete and Update Statement</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Delete and Update Statement</h6>
                    <h6 class="text-white"><?php echo "$name";?></h6>
                </div>
            </nav>

            <h2>Delete and Update Statement</h2>
            
            <div class="card shadow p-3 mb-5 bg-white rounded">
            <div class="card-body">
            <h5 class="card-title">UPDATE AND DELETE </h5>
            <p class="text-dark">We now know how to create a table, how to insert values into a table, how to retrieve data from the table, we’re missing something else. What if we needed to change the data after it has been inserted? For this purpose, you need the UPDATE command. You can also delete entire rows with the help of the DELETE command. For both these commands, you might need to use them on specific rows in the table, you can find those rows using the WHERE clause to match a condition. 
            </p>
            </div>
            </div>
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/9idAPkxntSk?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br><br>
            <a href="web-day3-module6.php">
