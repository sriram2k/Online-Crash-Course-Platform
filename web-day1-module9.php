    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 9:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp Inputs</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Inputs</h6>
            ...
            <p class="text-dark">Inputs are used to get data from the user. To get input, the 'input' tag is used. There are many input types that can be used in the HTML like text, number, button etc. which can be specified by the type attribute. The input tags can have other attributes like name, value and id. The input tags are commonly used with the forms to send the data from the user to the backend. Let's learn the various input types and attributes with example</p>
            
            </div>
            </div>
           <iframe width="100%" height="415" src="https://www.youtube.com/embed/f2z280UCJgs?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
             <br>
                <a href="web-day1-module8.php">
                    <button class="btn btn-dark" style="float: left;border-radius: 0px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Prev</button>
                </a>
                <a href="web-day1-module10.php">
