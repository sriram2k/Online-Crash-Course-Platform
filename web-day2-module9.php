    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 9:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Transitions</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Transitions</h6>
            ...
            <p class="text-dark">Transitions are used to change the styling of an HTML element smoothly, thus creating a moving effect. This can make your website look smooth. There are several ways of creating a transition in CSS, one of them is the hover selector property. We’ll make use of this in our examples. Some of the ways you can use these transition effects are, change the color of an element when it’s clicked, or change the size of an element when we move the mouse pointer over it. We’ll see some examples to understand this. 
            </p>
            </div>
            </div>
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/PLqmzSssVsY?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br><br>
