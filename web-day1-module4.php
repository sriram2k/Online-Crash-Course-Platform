    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 4:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp Styles & Formatting</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Styles & Formatting</h6>
            ...
            <p class="text-dark">Styles are used to make our webpage look more visually appealing. Using styles, we can change how the HTML elements appear on the webpage. Some basic ways of using a style are changing the color, height, width, position of HTML elements. Styling of text content is done by formatting properties. You can make the text look bold, italic, underline and even change the color of the text. If your webpage has a lot of textual content, you can align them appropriately using the alignment options. We’ll discuss these with examples in the video.</p>
           <!-- <p class="text-dark">It is used for:
            ...
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/Nxv3rUyO1q0?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
             <br>
