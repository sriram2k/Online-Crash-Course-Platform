    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 1:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Introduction to CSS</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Introduction to CSS</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">CSS INTRODUCTION</h5>
            <p class="text-dark">
CSS stands for Cascading Style Sheet. CSS is used to define styles for your web pages, including the design, colors, layout, and variations. CSS describes how HTML elements are to be displayed on the screen on a webpage. If you consider the website as house the CSS will be the paints and interior decorations without it the house may fulfill its primary function but it won’t be good to live at.   

            </p>
            </div>
            </div>
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/9sQwzSjam3A?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
                <br>
                
                <a href="web-day2-module2.php">
