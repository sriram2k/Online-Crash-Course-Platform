    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 3:</h5>
                <h5><i class="fa fa-server" aria-hidden="true"></i>&nbsp Variables and data types</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Variables and data types</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">Variables and data types</h5>
            <p class="text-dark">
    
The basic structure of PHP code. <br>
Just like HTML code is embedded inside the <html> tag, PHP code is similarly embedded inside a PHP tag. One of the fundamental concepts of a programming language is variables. These variables are used to store values. In PHP, all the variable names start with a $ sign.

Datatypes are the different types of data that a variable can hold. The datatypes which are allowed in PHP are <br>
String<br>
Integer<br>
Float <br>
Boolean<br>
...
Resource<br>
            ...
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/Br8nqaxqw1k?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
             <br>
                <a href="web-day4-module2.php">
