    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 10:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Animations</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Animations</h6>
            ...
            <p class="text-dark"></p>
            <p class="text-dark">Animations are similar to transitions. They allow us to create an animation without the help of javascript. The main concept in animations is keyframes. It denotes how much of the animation has been completed. You can change the styling of an element at different stages of the animation such as changing the color 5 times during the animation. We’ll see these with an example. You can extend this example and create other cool looking animations. 
            </p>
            </div>
            </div>
           <iframe width="100%" height="415" src="https://www.youtube.com/embed/bcPZ1wm2-bs?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br><br>
           <a href="web-day2-module9.php">
                    <button class="btn btn-dark" style="float: left;border-radius: 0px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Prev</button>
                </a>
                <a href="web/day2-mcq.html">
                    <button class="btn btn-dark" style="float: right;border-radius: 0px;"> MCQ&nbsp;<i class="fa fa-certificate" aria-hidden="true"></i></i></button>
                </a>
        </div>
    </div>
