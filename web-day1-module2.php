    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 2:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp Elements & Attributes</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Elements & Attributes</h6>
            ...
            <p class="text-dark">The HTML code of a webpage is made up of smaller elements called tags. These tags are predefined and each one of them serves a purpose. Based on how we want the webpage to look, we can make use of the appropriate tags to show the content. Some of these tags may have attributes. These attributes increase the functionality of the tags. In this video, we’ll discuss the basic structure of a webpage using some of the tags and attributes. We have also discussed the use of a text editor called Sublime Text. You can download it from <a href ="https://www.sublimetext.com/3">here</a>.</p>
           <!-- <p class="text-dark">It is used for:
            ...
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/9t9LPoIIbiE?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
             <br>
                <a href="web-day1-module1.php">
                    <button class="btn btn-dark" style="float: left;border-radius: 0px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Prev</button>
                </a>
                <a href="web-day1-module3.php">
