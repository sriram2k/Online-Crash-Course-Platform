    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 6:</h5>
                <h5><i class="fa fa-server" aria-hidden="true"></i>&nbsp Form Handling</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Form Handling</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">Form Handling</h5>
            <p class="text-dark">There are 2 ways to submit data from the form - GET and POST.
The main difference between get and post is that the data submitted through the get request is visible in the url but if the data submitted through post the data submitted will not be visible in the url.

            </p>
            </div>
            </div>
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/B00XVrIULmA?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
             <br>
