...
?>      <div class="sidebar-header b-dark" >
                <h5>Lesson 8:</h5>
                <h5><i class="fa fa-server" aria-hidden="true"></i>&nbsp Cookies and Sessions</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Cookies and Sessions</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">Cookies and Sessions</h5>
            <p class="text-dark">A cookie is a small file that the server embeds on the user's computer. Each time the same computer requests a page with a browser, it will send the cookie too. With PHP, you can both create and retrieve cookie values. Cookies are used to store commonly used less secure data 

A session is a way to store information (in variables) to be used across multiple pages. Unlike cookies, the session information is stored on the server. Session data is used to remember important information such as username etc when your website contains multiple pages. Otherwise, the user would have to login every time he visits a new page on the website.

            </p>
            </div>
            </div>
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/8KSWNzA5Ijg?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
             <br>
                <a href="web-day4-module7.php">
