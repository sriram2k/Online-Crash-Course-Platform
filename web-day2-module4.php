    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 4:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Selector, Classes & Ids</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Selector, Classes & Ids</h6>
                    <h6 class="text-white"><?php echo "$name";?></h6>
                </div>
            </nav>

            <h2>Selector, Classes & Ids</h2>
            
            <div class="card shadow p-3 mb-5 bg-white rounded">
            <div class="card-body">
            <h5 class="card-title">SELECTORS ,CLASSES & IDS</h5>
            <p class="text-dark">The selectors are the ones who find and select the element that you want to style in the site. The selector has many types such as the element selector, the class selector, the id selector
And you can even use multiple selectors to give common CSS by using the grouping selectors.
So let’s move on and see how this works with help of examples.

            </p>
            </div>
            </div>
           <iframe width="100%" height="415" src="https://www.youtube.com/embed/v3T9D07wzBQ?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           <br><br>
           <a href="web-day2-module3.php">
