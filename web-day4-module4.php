    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 4:</h5>
                <h5><i class="fa fa-server" aria-hidden="true"></i>&nbsp Conditional loops </h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Conditional loops </h6>
            ...
            <div class="card-body">
            <h5 class="card-title">Conditional loops </h5>
            <p class="text-dark">
                
                Conditional statements are used to perform different actions based on different conditions. These conditions are specified using the if..else or if..elseif statements.
In the if..else statement. You specify the condition along with the if, this block of code is executed when the condition is satisfied. If the condition is not satisfied, the else block is executed.
<br><br>
Often when you write code, you want the same block of code to run over and over again a certain number of times. So, instead of adding several almost equal code-lines in a script, we can use loops.
Examples of the loops while loop and foreach loop <br>

                
            </p>
            </div>
            </div>
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/y4R8KiMr_eI?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
             <br>
                <a href="web-day4-module3.php">
                    <button class="btn btn-dark" style="float: left;border-radius: 0px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Prev</button>
                </a>
                <a href="web-day4-module5.php">
