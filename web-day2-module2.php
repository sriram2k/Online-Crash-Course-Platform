    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 2:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Adding CSS to HTML</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Adding CSS to HTML</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">ADDING CSS TO HTML</h5>
            <p class="text-dark">For designing the website, we have to add the CSS to the HTML first,  to add the CSS to the HTML there are three ways, inline internal and external, in inline styling we will add CSS directly in the element, internal styling the CSS is added int the head section and in external styling, we will create a new separate CSS file for adding CSS. let’s learn them one by one using examples.
            </p>
            </div>
            </div>
           <iframe width="100%" height="415" src="https://www.youtube.com/embed/l15XIccjkWw?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           <br><br>
           <a href="web-day2-module1.php">
