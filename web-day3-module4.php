    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 4:</h5>
                <h5><i class="fa fa-database" aria-hidden="true"></i>&nbsp Create and Insert Statement</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Create and Insert Statement</h6>
                    <h6 class="text-white"><?php echo "$name";?></h6>
                </div>
            </nav>

            <h2>Create and Insert Statement</h2>
            
            <div class="card shadow p-3 mb-5 bg-white rounded">
            <div class="card-body">
            <h5 class="card-title">CREATE AND INSERT </h5>
            <p class="text-dark">Welcome back. So far we have seen the basic concepts of a database. In this video, we’ll directly go into handling databases. We’ll be discussing CREATE and INSERT commands in MySQL. While creating a table, you’ll define its schema. A schema is nothing but the structure of the table. This includes the column names, their data types and their optional constraints. Once a table has been created, you can use the INSERT command to insert the data into the tables. 
            </p>
            </div>
            </div>
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/hN3hwY6VRBA?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br><br>
            <a href="web-day3-module3.php">
