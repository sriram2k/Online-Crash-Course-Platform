    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 3:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Common properties</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Common properties</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">COMMON PROPERTIES</h5>
            ...
            <p class="text-dark">There are plenty of styling properties available in CSS, but some properties are more commonly used than others some of them are color, background-color, background image, and spacing options. These are most commonly used and can be seen on any website you visit. Let’s see through them one by one using examples.
            </p>
            </div>
            </div>
             <iframe width="100%" height="415" src="https://www.youtube.com/embed/aNGe9sM_2bw?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
             <br><br>
