    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 2:</h5>
                <h5><i class="fa fa-database" aria-hidden="true"></i>&nbsp Data types</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Data types</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">DATATYPES </h5>
            <p class="text-dark">Datatypes are the basic units of data that can be stored in a database. There are several data types available in MySQL. Some of them are varchar, integer, float, bool, datetime. In this video, we’ll see each one of these topics one by one. The data that you store in the tables must be of one of the data types in MySQL. While creating the table, you have to specify the data types for each field. You cannot insert a value of a different data type into the table. 
            </p>
            </div>
            </div>
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/h6aR5RfNqrA?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br><br>
            <a href="web-day3-module1.php">
