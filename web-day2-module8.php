    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 8:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Nav bar</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Nav bar</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">NAVBAR IN CSS</h5>
            <p class="text-dark">Navbar is a user interface element that is used in websites to navigate to the other parts of the website. It contains all the important links and is generally accessible from any page.  Navbar is a combination of unordered list with list elements and anchor tags. Almost all websites contain a navbar. It can also be used as a menu option. You can either use a horizontal or vertical navbar. In this video, we’ll see how to create a navbar step by step with an example. 
            </p>
            </div>
            </div>
           <iframe width="100%" height="415" src="https://www.youtube.com/embed/r1xkqJEwJTc?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br><br>
           <a href="web-day2-module7.php">
