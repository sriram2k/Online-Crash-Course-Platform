    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 7:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp  Class & Id</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block"> Class & Id</h6>
            ...
            <p class="text-dark">Classes and IDs are attributes for the element which are used to name the HTML elements. They are extensively used in CSS, JavaScript and PHP. The main difference between class and id is that multiple elements can have the same class name but the ID names should be unique for each element. They make functions and stylings much easier and modular. </p>
            
            </div>
            </div>
           <iframe width="100%" height="415" src="https://www.youtube.com/embed/pvWCZn02MI4?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
             <br>
