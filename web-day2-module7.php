    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 7:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Shadows</h5>
            </div>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                  ...
                  <p class="float-right time"><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp 3min 56secs</p>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Shadows</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">CSS SHADOWS</h5>
            <p class="text-dark">Shadows are commonly used to make the HTML elements look more stylish. Shadows can be applied to almost all the HTML elements such as text or block elements. You have to specify the horizontal and vertical shadow sizes. You can experiment with different values until you find one that looks good. Along with the sizes of the shadows, you can also make the shadow blurry to make it look smooth. You also have an option to change the color of the shadow. In this video, we’ll learn these with examples. 
            </p>
            </div>
            </div>
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/9ZoyDWT_-OY?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br><br>
