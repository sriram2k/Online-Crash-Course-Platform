    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 6:</h5>
                <h5><i class="fa fa-css3" aria-hidden="true"></i>&nbsp Layout Properties</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Layout Properties</h6>
            ...
            <div class="card-body">
            <h5 class="card-title">LAYOUT AND POSITIONING</h5>
            <p class="text-dark">HTML layout is used to specify how the elements are arranged on the webpage. In order to arrange the content of a webpage. We need to define their positions. There 5 ways of doing this. We’ll discuss each of them with an example in this video. Layout and positioning are used to improve the presentability of the webpage. Based on the purpose, the layout and positioning values can be chosen according to your convenience. 
            </p>
            </div>
            </div>
           <iframe width="100%" height="415" src="https://www.youtube.com/embed/-l9yYgnebQs?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           <br><br>
           <a href="web-day2-module5.php">
