    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 1:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp Course Objective</h5>
            </div>
        ...
        <div id="content">
            ...
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/nmzBQic0PD4?rel=0&autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
