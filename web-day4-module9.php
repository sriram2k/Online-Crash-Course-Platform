...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="card-body">
            <h5 class="card-title">Database access </h5>
            <p class="text-dark">you need to establish a connection between the database and your php code on the server. 
Before executing sql queries

$connectin variable = mysqli_connect(dbServerName, dbUserName,$dbPassword, dbName);
To execute a sql command 
This is used
mysqli_query($connection variable, $sql);
The $sql variable contains the sql command that you want to execute

This can be given into a variable to retrieve data from the database

            </p>
            </div>
            </div>
<iframe width="100%" height="400" src="https://www.youtube.com/embed/6XFnsEQ501I?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            <br>
             <br>
