    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 2:</h5>
                <h5><i class="fa fa-server" aria-hidden="true"></i>&nbsp Installation</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Installation</h6>
            ...
            <p class="text-dark">Php file cannot be opened directly by the browser because it is a server-side scripting language. it must be hosted by a server to work. So we will need a server and a database to run a php file. For that we are going to download Xammp. This provides apache server and mysql to make a local hosting in the system. The php file will be run with the help of this local host.
            </p>
            </div>
            </div>
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/hmFAWqWgrVQ?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
             <br>
                <a href="web-day4-module1.php">
