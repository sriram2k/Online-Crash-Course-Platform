    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="bg-dark">
            <div class="sidebar-header b-dark" >
                <h5>Lesson 6:</h5>
                <h5><i class="fa fa-html5" aria-hidden="true"></i>&nbsp Tables & Lists</h5>
            </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="margin-top:-20px; margin-left:-20px; margin-right:-20px; box-border: 2px 2px solid black">
                <div class="container-fluid">
                    ...
                    <h6 class="text-white d-none d-lg-block">Tables & Lists</h6>
            ...
            <p class="text-dark">Tables are used to organize or tabulate data in a webpage. An HTML table is defined with the table tag. Each table row is defined with the tr tag. A table header is defined with the th tag. By default, table headings are bold and centered. A table data/cell is defined with the td tag. Lists are used to list the items. The two main list types are ordered list and unordered list.
An ordered list starts with the ol tag.An unordered list starts with the ul tag. Each list item starts with the li tag.  We’ll discuss these with examples in the video.</p>
           
            </div>
            </div>
             <iframe width="100%" height="415" src="https://www.youtube.com/embed/_2SI-mkjw1Q?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
             <br>
